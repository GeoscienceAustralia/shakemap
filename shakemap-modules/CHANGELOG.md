...
## 1.1.16 / 2026-03-09
    ...
    - Fix bugs in model.py that prevented a reduced set of IMTs from being called in model.conf.
    - Fix bug in dataframe.py: FLOATRE string converted to raw string.
    - Fix test to change # of dyfi for Chile event.
    - Update esi-shakelib to v1.1.16.
